...
export function SetupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="card-gradient-border max-w-md w-full galaxy-fade-in">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-bold gradient-text">freellmapi-cf</h1>
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="card-gradient-border max-w-md w-full galaxy-fade-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {error && (
            <pre className="text-xs text-danger whitespace-pre-wrap break-words rounded p-2 max-h-48 overflow-auto alert-danger">
              {error}
            </pre>
          )}
