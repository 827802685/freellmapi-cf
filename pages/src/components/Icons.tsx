/**
 * Galaxy SVG 图标集 — 替换所有 emoji 按钮
 * 统一 stroke 风格,继承 currentColor
 */
...
export function IconEraser({ size = 16, className }: IconProps) {
  return (
    <svg {...base(size)} className={className}>
...
export function IconBrain({ size = 16, className }: IconProps) {
  return (
    <svg {...base(size)} className={className}>
      <path d="M12 2a3 3 0 0 0-3 3 3 3 0 0 0-3 3 3 3 0 0 0-1 5 3 3 0 0 0 2 4 3 3 0 0 0 5 1 3 3 0 0 0 5-1 3 3 0 0 0 2-4 3 3 0 0 0-1-5 3 3 0 0 0-3-3 3 3 0 0 0-3-3z" />
      <path d="M12 2v20" />
    </svg>
  );
}
